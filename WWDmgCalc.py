...
class ResultDetailDialog(QDialog):
    ...
    def __init__(self, item, idx, parent_page, parent_window=None):
        ...
        inc_toggle.setStyleSheet("QPushButton { border: none; background: transparent; padding: 2px 0; text-align: left; } QPushButton:checked { font-weight: bold; }")
        ...
        boost_toggle.setStyleSheet("QPushButton { border: none; background: transparent; padding: 2px 0; text-align: left; } QPushButton:checked { font-weight: bold; }")
