...
class ResultDetailDialog(QDialog):
    ...
    def __init__(self, item, idx, parent_page, parent_window=None):
        ...
        inc_toggle.setStyleSheet("QPushButton { border: none; border-left: 3px solid rgba(128,128,128,0.3); background: transparent; padding: 2px 6px; text-align: left; border-radius: 0; } QPushButton:hover { border-left: 3px solid rgba(128,128,128,0.5); } QPushButton:checked { font-weight: bold; border-left: 3px solid rgba(100,180,255,0.5); }")
        ...
        boost_toggle.setStyleSheet("QPushButton { border: none; border-left: 3px solid rgba(128,128,128,0.3); background: transparent; padding: 2px 6px; text-align: left; border-radius: 0; } QPushButton:hover { border-left: 3px solid rgba(128,128,128,0.5); } QPushButton:checked { font-weight: bold; border-left: 3px solid rgba(100,180,255,0.5); }")
